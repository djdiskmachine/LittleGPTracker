...
|-------------|---------------|--------------|------------|---------|--------------------------------------|
| PSP         | NO            | NO           | YES        | No toolchain      | [See notes](projects/resources/PSP/INSTALL_HOW_TO.txt) |
| DEB         | YES           | YES          | YES        | YES     |                                      |
| X64         | YES           | YES          | MAYBE      | YES     |                                      |
| X86         | YES           | YES          | YES        | YES     |                                      |
| STEAM       | YES           | YES          | MAYBE      | YES     |                                      |
| MIYOO       | NO            | NO           | YES        | No deps      | Port by [Nine-H](https://ninethehacker.xyz) |
| W32         | YES           | YES          | YES        | YES     |                                      |
| RASPI       | YES           | YES          | YES        | YES     | Versatile platform                   |
| CHIP        | YES           | YES          | YES        | YES     | [See notes](projects/resources/CHIP/INSTALL_HOW_TO.txt) |
| BITTBOY     | MAYBE         | NO           | YES        | Yes, slow     |                                      |
| PORTMASTER  | MAYBE         | NO           | YES        | YES     |                                      |
| GARLIC      | NO            | NO           | NO         | NO      | No longer maintained, use Portmaster |
| GARLICPLUS  | MAYBE         | NO           | YES        | YES     | Port by [Simotek](http://simotek.net)|
| RG35XXPLUS  | MAYBE         | NO           | YES        | No toolchain      | Port by [Simotek](http://simotek.net)|
| MACOS       | YES           | YES          | YES        | YES      | Port by [clsource](https://genserver.social/clsource) |
